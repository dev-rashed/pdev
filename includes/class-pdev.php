...
class Pdev {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Pdev_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Pdev_Loader. Orchestrates the hooks of the plugin.
	 * - Pdev_i18n. Defines internationalization functionality.
	 * - Pdev_Admin. Defines all hooks for the admin area.
	 * - Pdev_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Pdev_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Pdev_Loader    Orchestrates the hooks of the plugin.
	 */
